...
# "Start" screen
drawText('Lets Press any key to start the game.', font, windowSurface, (WINDOWWIDTH / 3) - 50, (WINDOWHEIGHT / 3))
drawText('And Enjoy The game', font, windowSurface, (WINDOWWIDTH / 3), (WINDOWHEIGHT / 3)+50)
...
while (count>0):
    ...
    while True: # the game loop
        ...
        if moveLeft and playerRect.left > 0:
            playerRect.move_ip(-2 * PLAYERMOVERATE, 0)
        if moveRight and playerRect.right <WINDOWWIDTH:
            playerRect.move_ip(+2* PLAYERMOVERATE, 0)
        if moveUp and playerRect.top > 0:
            playerRect.move_ip(0,-2 * PLAYERMOVERATE)
